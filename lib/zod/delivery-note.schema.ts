...
export const deliveryNoteSchema = z
    .object({
        ...
        deliveryNoteNumber: z.number({ error: "Le numéro du bon de livraison est obligatoire." }),
        item: z.object({
...
export const deliveryNoteUpdateSchema = z
    .object({
        ...
        projectId: z.string({ error: "Le projet est requis" }),
        companyId: z.string({ error: "L'entreprise est requise" }),
        deliveryNoteNumber: z.number({ error: "Le numéro du bon de livraison est requis." }),
        item: z.object({
            productServices: z.array(itemSchema).optional(),
            billboards: z.array(itemSchema).optional(),
        }, { error: "Vous devez sélectionner au moins un produit/service ou un panneau publicitaire" }),
...
export type DeliveryNoteUpdateSchemaType = z.infer<typeof deliveryNoteUpdateSchema>;
