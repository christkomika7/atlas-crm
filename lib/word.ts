...
import { cell, clientContractOwner, companyContractOwner, createBillboardParagraphs, createFooter, createHeader, createText, createTitle, createTitleContent } from './word-utils';
...
export async function generateLessorContractDocument(contract: ContractType): Promise<Blob> {
    const doc = new Document({
        sections: [
            {
                properties: {},
