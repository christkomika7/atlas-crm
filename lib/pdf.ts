...
/**
 * Télécharge un composant React en tant que PDF haute qualité
 * Utilise html2canvas-pro qui supporte nativement OKLCH, LAB, LCH, OKLAB
 * 
 * @param elementId - L'ID de l'élément HTML à convertir
 * @param filename - Le nom du fichier PDF à télécharger
 * @param options - Options supplémentaires (quality, scale, margin, padding)
 */
...
/**
 * Télécharge un composant React (sans ID) en tant que PDF haute qualité
 * Le composant est rendu de manière invisible puis capturé
 * 
 * @param component - Le composant React à rendre (ReactNode)
 * @param filename - Le nom du fichier PDF à télécharger
 * @param options - Options supplémentaires (quality, scale, margin, padding)
 */
