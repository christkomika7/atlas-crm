...
import ItemList from "@/app/(dashboard)/invoice/create/_component/item-list";
import ItemModal from "@/app/(dashboard)/invoice/create/_component/item-modal";
import ProjectModal from "@/app/(dashboard)/invoice/_component/project-modal";
import InvoiceInfo from "@/app/(dashboard)/invoice/create/_component/invoice-info";
...
export default function InvoiceModal({ idClient, closeModal, refreshData }: InvoiceModalProps) {
