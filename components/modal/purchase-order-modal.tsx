...
import ItemList from "@/app/(dashboard)/purchase-order/create/_component/item-list";
import ItemModal from "@/app/(dashboard)/purchase-order/create/_component/item-modal";
import PurchaseOrderInfo from "@/app/(dashboard)/purchase-order/create/_component/purchase-order-info";
...
export default function PurchaseOrderModal({ idSupplier, closeModal, refreshData }: PurchaseOrderModalProps) {
    ...
    useEffect(() => {
        if (idSupplier) {
            ...
            form.setValue("supplierId", idSupplier);
            mutateSupplier(
                { id: idSupplier },
                {
                    onSuccess(data) {
