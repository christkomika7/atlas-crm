...
const buttonVariants = cva(
  "group inline-flex justify-center has-data-[arrow=true]:justify-between items-center disabled:opacity-60 focus-visible:outline-hidden ring-offset-background font-medium text-sm whitespace-nowrap whitespace-nowrap transition-[color,box-shadow] cursor-pointer disabled:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        delete:
          "bg-red text-white focus-visible:ring-red/20 !h-12 w-full cursor-pointer rounded-lg",
        "inset-primary":
          "bg-transparent border-2 border-blue text-blue !h-12 w-full cursor-pointer rounded-lg",
        select:
          "!h-11 bg-gray cursor-pointer justify-start !p-2 focus-visible:ring-blue",
        input:
          "bg-gray shadow-none !h-11  border-none rounded-lg focus-visible:ring-blue h-11 placeholder:text-neutral-700",
        task: "bg-gray flex justify-start px-6 gap-x-1  h-6 w-full",
      },
      appearance: {
        default: "",
        ghost: "",
