      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="top-4 right-4 absolute data-[state=open]:bg-accent opacity-70 hover:opacity-100 rounded-xs focus:outline-hidden focus:ring-2 focus:ring-blue ring-offset-background focus:ring-offset-2 [&_svg:not([class*='size-'])]:size-4 data-[state=open]:text-muted-foreground transition-opacity [&_svg]:pointer-events-none disabled:pointer-events-none [&_svg]:shrink-0"
          >
            <XIcon />
