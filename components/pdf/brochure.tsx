...
export default function Brochure({ items }: BrochureProps) {
    ...
    function getStaticMapUrl(mapUrl: string, width = 410, height = 210) {
        if (!mapUrl) return "";
    ...
    return (
        <div id="brochure">
            {images.map(item =>
                <div className="flex justify-center space-y-4 h-full">
                            ...
                            <div className="h-[586px] flex flex-col justify-end pb-4 w-full rounded-bl-2xl" style={{ backgroundColor: item.color }}>
                                <div className="flex justify-between items-end p-4">
                                    <div className="-space-y-1 text-white">
                                        <h1 className="!text-[52px] !font-black uppercase">{cutText(item.name, 12)} </h1>
                                ...
                                <div className="px-4 flex justify-between ">
                                    <div className="w-[415px] h-[410px] rounded-2xl overflow-hidden relative">
                                        ...
                                        <Image src={item.firstImage || "/empty.jpg"} width={415} height={410} alt="Image panneau 1" className="object-cover object-center empty" />
                                    </div>
                        ...
                        <div className="h-[257px] w-full z-10 relative bg-white">
                            <div className="!border-2 !border-black rounded-2xl h-[190px] p-4 grid grid-cols-2 gap-x-4">
                                <div className="space-y-2">
                                    <div className="grid grid-cols-[30px_1fr] !gap-x-2 items-center">
                                        <div className="size-[30px]">
                                            <Image src="/billboard.png" width={30} height={30} alt="Billboard icon" className="object-cover w-full object-center" />
                                        </div>
                                        <p className="font-medium">{item.type}</p>
                                    </div>
                                    <div className="grid grid-cols-[30px_1fr] gap-x-2 items-center">
                                        <div className="size-[30px]">
                                            <Image src="/route.png" width={30} height={30} alt="Route icon" className="object-cover w-full object-center" />
                                        </div>
                                        <p className="font-medium">{item.orientation}</p>
                                    </div>
                                    <div className="grid grid-cols-[30px_1fr] gap-x-2 items-center">
                                        <div className="size-[30px]">
                                            <Image src="/pin.png" width={30} height={30} alt="Pin map icon" className="object-cover w-full object-center" />
                                        </div>
                                ...
                                <div className="space-y-2">
                                    <div className="grid grid-cols-[30px_1fr] gap-x-2 items-center">
                                        <div className="size-[30px]">
                                            <Image src="/branding.png" width={30} height={30} alt="Branding icon" className="object-cover w-full object-center" />
                                        </div>
                                        <p className="font-medium">Panneau au sol (face x2)</p>
                                    </div>
                                    <div className="grid grid-cols-[30px_1fr] gap-x-2 items-center">
                                        <div className="size-[30px]">
                                            <Image src="/resize.png" width={30} height={30} alt="Resize icon" className="object-cover w-full object-center" />
                                        </div>
                                        <p className="font-medium">{item.width}m x {item.height}m</p>
                                    </div>
                                    <div className="grid grid-cols-[30px_1fr] gap-x-2 items-center">
                                        <div className="size-[30px]">
                                            <Image src="/check.png" width={30} height={30} alt="Check icon" className="object-cover w-full object-center" />
                                        </div>
                                        <p className="font-medium">Panneau au sol (face x2)</p>
                                    </div>
                                </div>
                            ...
                            <div className="!border-2 !border-black !items-center rounded-2xl h-[65px] px-8 gap-x-9 w-[320px] relative -top-3.5 !flex" style={{ backgroundColor: item.color }}>
                                <div className="size-[30px]">
                                    <Image src="/hash-tag.png" width={30} height={30} alt="Hashtag icon" className="object-contain object-center" />
                                </div>
                                <div className="!flex !items-center">
                                    <p className="text-white font-medium text-lg h-fit">{item.reference}</p>
                                </div>
                            </div>
                        </div>
                    </div>
