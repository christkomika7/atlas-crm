...
-- CreateEnum
CREATE TYPE "NotificationKindOf" AS ENUM ('INVOICE', 'PURCHASE_ORDER', 'QUOTE', 'DELIVERY_NOTE', 'RECEIPT', 'DISBURSEMENT', 'APPOINTMENT', 'TASK', 'TRANSFER');
...
-- CreateEnum
CREATE TYPE "SourceType" AS ENUM ('CASH', 'BANK', 'WITHDRAWAL');

-- CreateEnum
CREATE TYPE "Resource" AS ENUM ('DASHBOARD', 'CLIENTS', 'SUPPLIERS', 'INVOICES', 'QUOTES', 'DELIVERY_NOTES', 'PURCHASE_ORDER', 'CREDIT_NOTES', 'PRODUCT_SERVICES', 'BILLBOARDS', 'PROJECTS', 'APPOINTMENT', 'TRANSACTION', 'SETTING', 'CONTRACT', 'UNKNOWN_RESOURCE');
...
CREATE TABLE "billboard" (
    ...
    "delayContractStart" TIMESTAMP(3),
    "delayContractEnd" TIMESTAMP(3),
    "locationPrice" TEXT,
...
CREATE TABLE "lessor_type" (
    "id" TEXT NOT NULL,
    "type" "LessorSpace" NOT NULL DEFAULT 'PRIVATE',
    "name" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "_DibursementToSupplier" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_DibursementToSupplier_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_DibursementToSupplier_B_index" ON "_DibursementToSupplier"("B");
...
-- AddForeignKey
ALTER TABLE "billboard" ADD CONSTRAINT "billboard_structureTypeId_fkey" FOREIGN KEY ("structureTypeId") REFERENCES "structure_type"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "delivery_note" ADD CONSTRAINT "delivery_note_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "delivery_note" ADD CONSTRAINT "delivery_note_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "recurrence" ADD CONSTRAINT "recurrence_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "billboard_type" ADD CONSTRAINT "billboard_type_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "display_board" ADD CONSTRAINT "display_board_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "structure_type" ADD CONSTRAINT "structure_type_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "lessor_type" ADD CONSTRAINT "lessor_type_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "company_documents" ADD CONSTRAINT "company_documents_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "dibursement" ADD CONSTRAINT "dibursement_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "fiscal_object" ADD CONSTRAINT "fiscal_object_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "transaction_category" ADD CONSTRAINT "transaction_category_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "transaction_nature" ADD CONSTRAINT "transaction_nature_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "deletion" ADD CONSTRAINT "deletion_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "notification" ADD CONSTRAINT "notification_paymentDibursementId_fkey" FOREIGN KEY ("paymentDibursementId") REFERENCES "dibursement"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "notification" ADD CONSTRAINT "notification_receiptId_fkey" FOREIGN KEY ("receiptId") REFERENCES "receipt"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "product_service" ADD CONSTRAINT "product_service_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_DibursementToSupplier" ADD CONSTRAINT "_DibursementToSupplier_A_fkey" FOREIGN KEY ("A") REFERENCES "dibursement"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_DibursementToSupplier" ADD CONSTRAINT "_DibursementToSupplier_B_fkey" FOREIGN KEY ("B") REFERENCES "supplier"("id") ON DELETE CASCADE ON UPDATE CASCADE;
