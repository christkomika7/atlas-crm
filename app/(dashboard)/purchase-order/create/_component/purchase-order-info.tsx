...
export default function PurchaseOrderInfo({ isGettingDocument, isGettingPurchaseOrderNumber, reference, calculate, items, taxes, currency, discount, setDiscount, paymentLimit, TTCPrice, setPaymentLimit, isPaid, amountPaid }: PurchaseOrderInfoProps) {
    return (
        <>
