      ...
      >
        <div className="space-y-4.5 max-w-lg">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              {items.map((item) => (
                <ItemList key={item.itemType === "billboard" ? item.billboardId : item.productServiceId} item={item} locationBillboardDate={locationBillboardDate} calculate={calculate} taxes={company?.vatRates ?? []} amountPaid={new Decimal(0)} />
              ))}
            </div>
