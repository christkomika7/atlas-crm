...
export default function InvoiceInfo({ isGettingDocument, isGettingInvoiceNumber, reference, calculate, items, taxes, currency, discount, setDiscount, paymentLimit, TTCPrice, setPaymentLimit }: InvoiceInfoProps) {
    return (
        <>
