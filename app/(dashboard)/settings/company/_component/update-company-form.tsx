...
export default function UpdateCompanyForm({ id, company }: UpdateCompanyFormProps) {
  ...
  useEffect(() => {
    if (company) {
      form.reset({
        ...
        fiscal: company.fiscalYearStart && company.fiscalYearEnd && {
          from: new Date(company.fiscalYearStart),
          to: new Date(company.fiscalYearEnd),
        },
