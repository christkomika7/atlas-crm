...
import { SalesByItemItem } from '@/types/company.types';
import ExportChart from '../chart/export-chart';

type SellArticleProps = {
    isLoading: boolean;
    datas: SalesByItemItem[];
    currency: string;
}

export default function SellArticle({ isLoading, datas, currency }: SellArticleProps) {
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="h-14">
                            ...
                            <TableHead className="font-medium text-center">Produit | Service</TableHead>
