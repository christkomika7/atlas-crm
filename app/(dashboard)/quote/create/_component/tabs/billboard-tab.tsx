...
export default function BillboardTab({ isGettingBillboards, billboards, totalItems, pageSize, currentPage, setCurrentPage }: BillboardTabProps) {
  ...
  function toggleSelection(check: boolean, billboard: BillboardType) {
    ...
    if (check) {
      addItem({
        ...
        description: `Le panneau ${billboard.name} est un panneau de type ${billboard.type.name} mesurant ${billboard.width} m de largeur sur ${billboard.height} m de hauteur, avec une orientation ${billboard.orientation}.`,
