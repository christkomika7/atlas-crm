    ...
    if (activeSort && sortOrder) {
      switch (activeSort) {
        ...
        case "byAmount":
          ...
          break;
        case "byMovement":
          orderBy = [{ movement: sortOrder }, { createdAt: "desc" }];
          break;
        case "byCategory":
          orderBy = [{ category: { name: sortOrder } }, { createdAt: "desc" }];
          break;
        case "byNature":
          orderBy = [{ nature: { name: sortOrder } }, { createdAt: "desc" }];
          break;
        case "byDescription":
          orderBy = [{ description: sortOrder }, { createdAt: "desc" }];
          break;
        case "byAllocation":
          orderBy = [
          ...
          break;
        case "bySource":
          orderBy = [{ source: { name: sortOrder } }, { createdAt: "desc" }];
          break;
